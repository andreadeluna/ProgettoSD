...
Future<DeployedContract> loadContract() async{
  ...
  final contract = DeployedContract(ContractAbi.fromJson(abi, 'Elezioni'), EthereumAddress.fromHex(contractAddress));
  return contract;
}
...
Future<String> startElection(String name, Web3Client ethClient) async{
  /* Richiamo alla funzione callFunction e gli passo come parametro
	il nome della funzione che si richiama come definito nello smart contract, in questo caso "inizioVotazione",
	i parametri della funzione che si richiama, in questo caso il nome/titolo della votazione che l'utente ha inserito,
	la chiave privata del proprietario del contratto in quanto solo lui può richiamare questa funzione */
  var response = await callFunction('inizioVotazione', [name], ethClient, owner_private_key);
...
/* Richiamo alla funzione callFunction e gli passo come parametro
	il nome della funzione che si richiama come definito nello smart contract, in questo caso "agiungiCandidato",
	i parametri della funzione che si richiama, in questo caso il nome/titolo della votazione che l'utente ha inserito,
	la chiave privata del proprietario del contratto in quanto solo lui può richiamare questa funzione */
  var response = await callFunction('aggiungiCandidato', [name, partito, descrizione], ethClient, owner_private_key);
...
Future<String> authorizeVoter(String address, Web3Client ethClient) async{
  /* Richiamo alla funzione callFunction e gli passo come parametro
	il nome della funzione che si richiama come definito nello smart contract, in questo caso "autorizzaElettore",
	i parametri della funzione che si richiama, in questo caso l'indirizzo dell'elettore convertito in indirizzo ethereum,
	la chiave privata del proprietario del contratto in quanto solo lui può richiamare questa funzione */
  var response = await callFunction('autorizzaElettore', [EthereumAddress.fromHex(address)], ethClient, owner_private_key);
...
Future<List> getCandidatesNum(Web3Client ethClient) async{
  /* Richiamo alla funzione ask e gli passo come parametro
	il nome della funzione che si richiama come definito nello smart contract, in questo caso "getNumeroCandidati",
	i parametri della funzione che si richiama, in questo caso nessuno,
	il client Web3*/
...
/* Richiamo alla funzione ask e gli passo come parametro
	il nome della funzione che si richiama come definito nello smart contract, in questo caso "getVotiTotali",
	i parametri della funzione che si richiama, in questo caso nessuno,
	il client Web3	*/
...
/* Richiamo alla funzione ask e gli passo come parametro
il nome della funzione che si richiama come definito nello smart contract, in questo caso "infoCandidato",
i parametri della funzione che si richiama, in questo caso l'indice del candidato,
il client Web3 */
Future<List> candidateInfo(int index, Web3Client ethClient) async{
  List<dynamic> result = await ask('infoCandidato', [BigInt.from(index)], ethClient);
...
Future<String> vote(int candidateIndex, Web3Client ethClient) async{
  /* Richiamo alla funzione callFunction e gli passo come parametro
	...
	i parametri della funzione che si richiama, in questo caso l'indice del candidato che si vuole votare,
	la chiave privata dell'elettore che sta votando */
  var response = await callFunction("votazione", [BigInt.from(candidateIndex)], ethClient, voter_private_key);
